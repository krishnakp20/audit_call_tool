...
export default function DashboardPage() {
  ...
  const summary = useDashboardSummary(clientId);
  const agentPerformance = useAgentPerformance(clientId);
  ...
  return (
    <div className="space-y-5">
        ...
        <button
          ...
          onClick={async () => {
            ...
            const response = await api.get("/export", {
              params: { client_id: clientId, from, to },
              responseType: "blob"
            });
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard title="Avg Score" value={summary.data?.avg_score ?? 0} accent="from-emerald-500 to-cyan-500" />
